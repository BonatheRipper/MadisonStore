...
const CartPage = () => {
  ...
  return (
    <div className="bg-[#F1FFFD] px-8 md:px-24 py-24 flex flex-col justify-between  w-full space-y-4">
      <p className="text-c-green   t font-medium ">{`Home > Cart`}</p>
      <h2 className="font-fair  text-c-green text-3xl tracking-loose">Cart</h2>
        ...
        <div className="flex flex-col md:flex-row justify-between w-full space-y-6 md:space-x-24">
          ...
          >
            ...
            <div class="flex justify-between">
              ...
              <p class="text-gold font-body text-md text-center font-bold">3</p>
            </div>
            <div class="flex justify-between">
              <p class="text-gold font-body text-md text-center font-bold">
                Total:
            ...
            <p class="text-gold font-body text-md text-center font-bold">
              ...
              as your card number with any three digits as CVC and a future date
              as expiration date during checkout.
            </p>
          </div>
        </div>
      </div>
      <LongButtons
        ...
        css={`
          ${themeBG} w-full hover:text-black hover:border border-c-gold
        `}
      />
    </div>
  );
